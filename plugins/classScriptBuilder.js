...
function jsonToDrawioXmlClass(diagram) {
  ...
  for (const cls of classesAndInterfaces) {
    ...
    if (cls[name].attributes.length > 0)
...
//const res = jsonToDrawioXmlClass(diagram);
